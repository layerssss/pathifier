...
class Website {
    ...
    handleRequest(request, response, protocol='http') {
        ...
        requestHeaders['X-Forwarded-Proto'] = requestHeaders['X-Forwarded-Proto'] || protocol;
        requestHeaders['X-Forwarded-Scheme'] = requestHeaders['X-Forwarded-Scheme'] || protocol;
        requestHeaders['X-Forwarded-Port'] = requestHeaders['X-Forwarded-Port'] || request.socket.localPort;
